...
run_once({"unclutter -root",
          ...
          "blueman-applet",
          "picom",
          "touchegg" }) -- comma-separated entries
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "e", function () awful.spawn("nemo") end,
              {description = "run browser", group = "launcher"}),
    awful.key({ modkey }, "r", function () awful.spawn("/home/herman/.config/rofi/launchers/type-3/launcher.sh") end,
              {description = "run app launcher", group = "launcher"}),
    awful.key({ "Control" }, "Escape", function () awful.spawn("/home/herman/.config/rofi/powermenu/type-2/powermenu.sh") end,
              {description = "run powermenu", group = "launcher"}),
    awful.key({ "Control", "Shift" }, "Escape", function () awful.spawn("wezterm start htop") end,
              {description = "run powermenu", group = "launcher"}),
...
awful.spawn.with_shell("feh --bg-fill /home/herman/Media/wallpapers/lighthouse_moon.jpg")
